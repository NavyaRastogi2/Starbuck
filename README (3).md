...
All screenshots show the simulated monsoon evening at **6:35 PM**.

### 1. Pulse — what is happening across Jaipur?
Zones tinted by stress, with a possible link between rain in North Jaipur, runoff towards Johari Bazaar and a slowdown on MI Road.

![Pulse mode](screenshots/1_pulse.png)

### 2. Weather — where is it raining, and where will the water go?
Rain, temperature, AQI and humidity by zone, with estimated runoff travel times on the map.

![Weather mode](screenshots/2_weather.png)

### 3. Route — what is coming up on my trip?
Vaishali Nagar to Hawa Mahal: time left, average speed and hurdles ahead with distance.

![Route mode](screenshots/3_route.png)

### 4. Ground reports — what is happening on the ground?
Incident map (bigger circles = more serious) and report cards with source, confirmations and a verified badge.

![Ground reports mode](screenshots/4_Ground_Reports.png)

### 5. AI Navi
Rule-based plain-language summary of the current feeds, with quick-question chips and a free-text box.

![AI Navi](screenshots/5_AI_Navi.png)

### 6. Civic contributors
Sample leaderboard of contributor handles with points, verified and submitted reports.

![Civic contributors leaderboard](screenshots/6_leaderboard.png)
